...
public extension PixelFormat {
    ...
    /// - Returns: `true` if the format is in gamma space, otherwise `false`.
    func isGammaColorSpaceFormat() -> Bool {
        switch self {
        case .R32G32B32A32_Float,
             .R32G32B32_Float,
             .R16G16B16A16_Float,
    ...
    func getSizeInBits() -> UInt {
        ...
        case .Unknown,
            ...
            return 4
        //default:
        //    fatalError("Unsupported PixelFormat: \(self)")
        }
    }
}
